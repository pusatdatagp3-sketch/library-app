...
<head>
    ...
    <link rel="icon" href="<?php echo $aliases->get('@baseUrl/favicon.svg') ?>" type="image/svg+xml">
    ...
    <div class="admin-wrapper">
        ...
        <aside class="admin-sidebar">
            ...
            <div class="sidebar-brand">
                ...
                <svg class="logo-full" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 216.495"
                ...
                <svg class="logo-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 160 216.495"
                    style="height: 28px; width: auto; flex-shrink: 0; display: none;">
                    <style>
                    .st0 {
                        fill: #40b3d8
                    }
            ...
            <footer class="admin-footer">
                ...
                <div class="footer_icons">
                    ...
                    <a href="https://join.slack.com/t/yii/shared_invite/enQtMzQ4MDExMDcyNTk2LTc0NDQ2ZTZhNjkzZDgwYjE4YjZlNGQxZjFmZDBjZTU3NjViMDE4ZTMxNDRkZjVlNmM1ZTA1ODVmZGUwY2U3NDA"
                        target="_blank" rel="noopener" title="Slack">
