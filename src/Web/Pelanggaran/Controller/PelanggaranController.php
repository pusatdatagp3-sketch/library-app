...
namespace App\Web\Pelanggaran\Controller;

use App\Web\Pelanggaran\Model\Pelanggaran;
...
final class PelanggaranController
{
    private $repository;
    ...
    public function __construct(
        ...
        $this->repository = $orm->getRepository(Pelanggaran::class);
    }
    ...
    public function create(ServerRequestInterface $request): ResponseInterface
    {
        ...
        if ($request->getMethod() === 'POST') {
            ...
            if ($model->validate()) {
                ...
                $this->flash->set('success', 'Data Pelanggaran berhasil ditambahkan.');
                return $this->responseFactory->createResponse(302)
                    ->withHeader('Location', $this->urlGenerator->generate('pelanggaran/index'));
            }
        }
    ...
    public function update(ServerRequestInterface $request): ResponseInterface
    {
        ...
        if ($request->getMethod() === 'POST') {
            ...
            if ($model->validate()) {
                $this->entityManager->persist($model)->run();
                $this->flash->set('success', 'Data Pelanggaran berhasil diperbarui.');
                return $this->responseFactory->createResponse(302)
                    ->withHeader('Location', $this->urlGenerator->generate('pelanggaran/index'));
            }
        }
    ...
    public function delete(): ResponseInterface
    {
        ...
        if ($model !== null) {
            ...
            $this->flash->set('success', 'Data Pelanggaran berhasil dihapus.');
        }
