...
<div class="crud-container max-w-lg">
    ...
    <div class="card">
        <form action="<?= $urlGenerator->generate('konsulat/update', ['id' => $model->id]) ?>" method="POST" class="form-grid">
            ...
            <div class="form-actions">
                <a href="<?= $urlGenerator->generate('konsulat/index') ?>" class="btn btn-secondary">Batal</a>
